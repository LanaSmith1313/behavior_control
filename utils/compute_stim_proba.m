...
if handles2give.aud_stim_amp_range
    weight_1 = handles2give.aud_stim_weight_1;
    weight_2 = handles2give.aud_stim_weight_2;
    weight_3 = handles2give.aud_stim_weight_3;
    weight_4 = handles2give.aud_stim_weight_4;

    aud_stim_weight = weight_1+weight_2+weight_3+weight_4;
else
